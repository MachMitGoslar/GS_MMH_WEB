...
<section class="team-section">
    <div class="grid content">
        <br />
        <h1 class="font-titleXXL grid-item" data-span="1/1"><?php $title ?? 'Teams & Unterstützer:innen'; ?></h1>
        <h1 class="font-title grid-item" data-span="1/1"><?php $subtitle ?? 'Unsere Teams, Helfer:innen und Partner'; ?></h1>
