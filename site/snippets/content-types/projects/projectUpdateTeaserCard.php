...
<li class="c-projectUpdateTeaser-card">
  ...
  <div class="content">
    ...
    <h3 class="font-headline font-line-height-narrow mb-2"><a href="<?= $project_step->parent()->url() ?>"><?= $project->title() ?></a></h3>
    <h4 class="font-subheadline font-line-height-narrow mb-2"><a href="<?= $project_step->parent()->url() ?>"><?= $project_step->headline() ?></a></h4>
