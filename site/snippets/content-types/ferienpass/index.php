...
<?php
/**
 * Description: This snippet is responsible for fetching event data for the
 * "Ferienpass" program and returning it as JSON. It uses the Kirby HTTP
 * Remote class to make API requests to the Feripro service, retrieves events for a
 * specific program, and formats the response accordingly.
 *
